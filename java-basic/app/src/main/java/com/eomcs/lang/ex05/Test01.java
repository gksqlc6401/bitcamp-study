...
public class Test01 {
  public static void main(String[] args) {
    ...
    int LANG_C      = 0b10000000; //0x80
    int LANG_CPP    = 0b01000000; //0x40
    int LANG_JAVA   = 0b00100000; //0x20
    int LANG_JS     = 0b00010000; //0x10
    int LANG_PYTHON = 0b00001000; //0x08
    int LANG_PHP    = 0b00000100; //0x04
    int LANG_HTML   = 0b00000010; //0x02
    int LANG_CSS    = 0b00000001; //0x01
